...
#pragma warning restore 0169, 0649
            ...
            this(bas)
        {
            ...
            if(this.ParentPacket is IPv4Packet)
            {
                ...
                //log.DEBUGFormat("Header.Length {0}, Current payload length: {1}, new payload length {2}", this.header.Length, payloadPacketOrData.TheByteArraySegment.Length,  newTcpPayloadLength);
