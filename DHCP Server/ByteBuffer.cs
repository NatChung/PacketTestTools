...
namespace PIXIS.DHCP
{
    public class ByteBuffer
    {
        ...
        {
            byte[] encode = buf.getBytes((int)buf.getLength());
            put(encode, 0, encode.Length);
            return this;
        }
        ...
        {
            byte[] byteArray = BitConverter.GetBytes(value).Reverse().ToArray();
        ...
        {
            byte[] byteArray = BitConverter.GetBytes((short)value).Reverse().ToArray();
            writer.Write(byteArray);
            return this;
        }
